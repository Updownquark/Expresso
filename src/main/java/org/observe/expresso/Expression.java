...
public interface Expression {
	...
	public static class ExpressionSearch {
		...
		public ExpressionSearch firstChild() {
			theSequence.add(new ChildSearchOp(FunctionUtils.printableFn(BetterList::peekFirst, "first", null)));
			return this;
		}
		...
		public ExpressionSearch text(String text) {
			return iff(FunctionUtils.printablePred(ex -> ex.toString().equals(text), "text:" + text, null));
		}
		...
		public ExpressionSearch textLike(Pattern pattern) {
			return iff(FunctionUtils.printablePred(ex -> pattern.matcher(ex.toString()).matches(), "textLike:" + pattern.pattern(), null));
		}
